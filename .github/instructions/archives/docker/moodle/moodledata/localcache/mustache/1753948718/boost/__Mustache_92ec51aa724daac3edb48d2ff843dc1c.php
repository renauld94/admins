...
class __Mustache_92ec51aa724daac3edb48d2ff843dc1c extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        if ($parent = $this->mustache->loadPartial('core_form/element-group')) {
            $context->pushBlockContext(array(
                'element' => array($this, 'block6e785fb346bf4c96a1bcbe92a749716e'),
            ));
...
';
    ...
    public function block6e785fb346bf4c96a1bcbe92a749716e($context)
    {
        $indent = $buffer = '';
