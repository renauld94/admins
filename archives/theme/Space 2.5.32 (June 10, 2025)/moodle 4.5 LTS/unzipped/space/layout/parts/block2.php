...
$block2introtitle = format_text(theme_space_get_setting('block2introtitle'), FORMAT_HTML, ['noclean' => true]);
$block2introcontent = format_text(theme_space_get_setting('block2introcontent'), FORMAT_HTML, ['noclean' => true]);
$block2html = format_text(theme_space_get_setting('block2htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block2footer = format_text(theme_space_get_setting('block2footercontent'), FORMAT_HTML, ['noclean' => true]);

$block2herotitle = format_text(theme_space_get_setting("block2herotitle"), FORMAT_HTML, ['noclean' => true]);
$block2herosubheading = format_text(theme_space_get_setting("block2herosubheading"), FORMAT_HTML, ['noclean' => true]);
$block2herocaption = format_text(theme_space_get_setting("block2herocaption"), FORMAT_HTML, ['noclean' => true]);
