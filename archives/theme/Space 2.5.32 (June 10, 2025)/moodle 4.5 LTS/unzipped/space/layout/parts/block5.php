...
$block5introtitle = format_text(theme_space_get_setting('block5introtitle'), FORMAT_HTML, ['noclean' => true]);
$block5introcontent = format_text(theme_space_get_setting('block5introcontent'), FORMAT_HTML, ['noclean' => true]);
$block5html = format_text(theme_space_get_setting('block5htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block5footer = format_text(theme_space_get_setting('block5footercontent'), FORMAT_HTML, ['noclean' => true]);
...
for ($i = 1; $i <= $block5count; $i++) {
    ...
    $title = format_text(theme_space_get_setting("block5itemtitle" . $i), FORMAT_HTML, ['noclean' => true]);
