...
for ($i = 1; $i <= $block1count; $i++) {
    ...
    $title = format_text(theme_space_get_setting("block1slidetitle" . $i), FORMAT_HTML, ['noclean' => true]);
    $subheading = format_text(theme_space_get_setting("block1slidesubheading" . $i), FORMAT_HTML, ['noclean' => true]);
    $caption = format_text(theme_space_get_setting("block1slidecaption" . $i), FORMAT_HTML, ['noclean' => true]);
