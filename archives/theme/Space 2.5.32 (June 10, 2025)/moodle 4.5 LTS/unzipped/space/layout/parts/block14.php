...
// Variables..
$block14introtitle = format_text(theme_space_get_setting('block14introtitle'), FORMAT_HTML, ['noclean' => true]);
$block14introcontent = format_text(theme_space_get_setting('block14introcontent'), FORMAT_HTML, ['noclean' => true]);
$block14html = format_text(theme_space_get_setting('block14htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block14footer = format_text(theme_space_get_setting('block14footercontent'), FORMAT_HTML, ['noclean' => true]);
