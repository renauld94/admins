...
// The jQuery module is only used for interacting with spacerap 4. It can we removed when MDL-71979 is integrated.
...
const disableButtonTooltip = (button, enableOnBlur) => {
    if (button.hasAttribute('data-original-title')) {
        // The jQuery is still used in spacerap 4. It can we removed when MDL-71979 is integrated.
