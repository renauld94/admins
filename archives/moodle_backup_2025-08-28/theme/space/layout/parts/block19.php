...
// Variables..
$block19introtitle = format_text(theme_space_get_setting('block19introtitle'), FORMAT_HTML, ['noclean' => true]);
$block19introcontent = format_text(theme_space_get_setting('block19introcontent'), FORMAT_HTML, ['noclean' => true]);
$block19html = format_text(theme_space_get_setting('block19htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block19footer = format_text(theme_space_get_setting('block19footercontent'), FORMAT_HTML, ['noclean' => true]);
