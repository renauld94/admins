...
$block4introtitle = format_text(theme_space_get_setting('block4introtitle'), FORMAT_HTML, ['noclean' => true]);
$block4introcontent = format_text(theme_space_get_setting('block4introcontent'), FORMAT_HTML, ['noclean' => true]);
$block4html = format_text(theme_space_get_setting('block4htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block4footer = format_text(theme_space_get_setting('block4footercontent'), FORMAT_HTML, ['noclean' => true]);
...
for ($i = 1; $i <= $block4count; $i++) {
    ...
    $q = format_text(theme_space_get_setting("block4question" . $i), FORMAT_HTML, ['noclean' => true]);
    $a = format_text(theme_space_get_setting("block4answer" . $i), FORMAT_HTML, ['noclean' => true]);
