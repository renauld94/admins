...
// Variables..
$block13introtitle = format_text(theme_space_get_setting('block13introtitle'), FORMAT_HTML, ['noclean' => true]);
$block13introcontent = format_text(theme_space_get_setting('block13introcontent'), FORMAT_HTML, ['noclean' => true]);
$block13html = format_text(theme_space_get_setting('block13htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block13footer = format_text(theme_space_get_setting('block13footercontent'), FORMAT_HTML, ['noclean' => true]);
