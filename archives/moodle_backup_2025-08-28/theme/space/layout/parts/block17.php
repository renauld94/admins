...
$block17introtitle = format_text(theme_space_get_setting('block17introtitle'), FORMAT_HTML, ['noclean' => true]);
$block17introcontent = format_text(theme_space_get_setting('block17introcontent'), FORMAT_HTML, ['noclean' => true]);
$block17html = format_text(theme_space_get_setting('block17htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block17footer = format_text(theme_space_get_setting('block17footercontent'), FORMAT_HTML, ['noclean' => true]);
