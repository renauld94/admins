...
$block15introtitle = format_text(theme_space_get_setting('block15introtitle'), FORMAT_HTML, ['noclean' => true]);
$block15introcontent = format_text(theme_space_get_setting('block15introcontent'), FORMAT_HTML, ['noclean' => true]);
$block15html = format_text(theme_space_get_setting('block15htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block15footer = format_text(theme_space_get_setting('block15footercontent'), FORMAT_HTML, ['noclean' => true]);
