...
$block3introtitle = format_text(theme_space_get_setting('block3introtitle'), FORMAT_HTML, ['noclean' => true]);
$block3introcontent = format_text(theme_space_get_setting('block3introcontent'), FORMAT_HTML, ['noclean' => true]);
$block3html = format_text(theme_space_get_setting('block3htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block3footer = format_text(theme_space_get_setting('block3footercontent'), FORMAT_HTML, ['noclean' => true]);

$block3herotitle = format_text(theme_space_get_setting("block3herotitle"), FORMAT_HTML, ['noclean' => true]);
$block3herosubheading = format_text(theme_space_get_setting("block3herosubheading"), FORMAT_HTML, ['noclean' => true]);
$block3herocaption = format_text(theme_space_get_setting("block3herocaption"), FORMAT_HTML, ['noclean' => true]);
