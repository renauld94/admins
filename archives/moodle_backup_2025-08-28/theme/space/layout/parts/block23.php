...
$block23introtitle = format_text(theme_space_get_setting('block23introtitle'), FORMAT_HTML, ['noclean' => true]);
$block23introcontent = format_text(theme_space_get_setting('block23introcontent'), FORMAT_HTML, ['noclean' => true]);
$block23html = format_text(theme_space_get_setting('block23htmlcontent'), FORMAT_HTML, ['noclean' => true]);
$block23footer = format_text(theme_space_get_setting('block23footercontent'), FORMAT_HTML, ['noclean' => true]);
$block23class = theme_space_get_setting('block23class');

$block23icon = format_text(theme_space_get_setting('FPHTMLCustomCategoryIcon'), FORMAT_HTML, ['noclean' => true]);
$block23heading = format_text(theme_space_get_setting('FPHTMLCustomCategoryHeading'), FORMAT_HTML, ['noclean' => true]);
$block23content = format_text(theme_space_get_setting('FPHTMLCustomCategoryContent'), FORMAT_HTML, ['noclean' => true]);
$block23html1 = format_text(theme_space_get_setting('FPHTMLCustomCategoryBlockHTML1'), FORMAT_HTML, ['noclean' => true]);
$block23html2 = format_text(theme_space_get_setting('FPHTMLCustomCategoryBlockHTML2'), FORMAT_HTML, ['noclean' => true]);
$block23html3 = format_text(theme_space_get_setting('FPHTMLCustomCategoryBlockHTML3'), FORMAT_HTML, ['noclean' => true]);
