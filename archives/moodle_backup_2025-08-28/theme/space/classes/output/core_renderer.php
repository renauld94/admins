...
class core_renderer extends \core_renderer {
    ...
    public function custom_menu($custommenuitems = '') {
        ...
        $skipfilters = ['activitynames', 'data', 'glossary', 'sectionnames', 'bookchapters', 'urltolink', 'bfurltolink'];
            ...
            for ($i = 0; $i < $items; $i++) {
                ...
                if ($headerlinks[$i]['status'] == true) {
                    ...
                    <a href="' . $headerlinks[$i]['url'] .
                        ...
                        '">
                        <span class="rui-sidebar-nav-icon" role="img" aria-label="' .
                        $headerlinks[$i]['title'] .
                        '">' .
                        $headerlinks[$i]['icon'] .
                        '</span>
        ...
        foreach ($courses as $course) {
            ...
            if ($course->visible || $ishidden) {
                ...
                if ($checkactive == true) {
                    ...
                    $iscurrenttag = 'aria-current="page"';
                }
                ...
                switch (true) {
                    case $timelineclassification == 'past':
                        $icon = '<div class="rui-sidebar-nav-icon rui-sidebar-nav-icon--completed" role="img" aria-label="' . get_string('completed', 'completion') . '">
                    ...
                    case $course->visible == 0:
                        $icon = '<div class="rui-sidebar-nav-icon rui-sidebar-nav-icon--completed" role="img" aria-label="' . get_string('visibilitynone', 'group') . '">
                        ...
                        break;
                    default;
                        $icon = '<div class="rui-sidebar-nav-icon" role="img" aria-label="' . get_string('course', 'moodle') . '">
                        <svg
                            width="20"
                            height="20"
                            viewBox="0 0 24 24"
